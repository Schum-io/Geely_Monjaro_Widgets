...
| **Кнопка рециркуляции воздуха**  | Включить\выключить рециркуляцию.
| **Обогрев заднего стекла**       | Включить\выключить обогрев стекла.
...
1. Скачать [monjaro-widgets](https://github.com/Schum-io/Geely_Monjaro_Widgets/releases) и установить:
2. Установить в систему автомобиля через root explorer
...
1. Скачать [psd-widget-module-release](https://github.com/Schum-io/Geely_Monjaro_Widgets/releases) и установить:
